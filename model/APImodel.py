...
class Model(BaseModel):
    id: str = Field(..., description="Identificador único para o modelo")
...
class PredictionRequest(BaseModel):
    model_id: str = Field(..., description="ID do modelo a ser usado para previsão")
    start_date: str = Field(..., description="Data de início para os dados no formato YYYY-MM-DD")
    end_date: str = Field(..., description="Data de término para os dados no formato YYYY-MM-DD")    
    days: int = Field(30, description="Número de dias para previsão")